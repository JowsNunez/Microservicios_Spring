...
import com.nunez.jose.micro_productos.service.IUnidadService;
...
public class UnidadRestController {
    ...
    @PutMapping("/{id}")
    public UnidadMedida update(@RequestBody UnidadMedida unidadMedida,@PathVariable Integer id){

            return _UnidadService.update(unidadMedida, id);
    }
}
